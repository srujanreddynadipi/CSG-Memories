...
export function createSeedClassmates() {
  return [
    { id: 'cm1', name: 'Karthik Naik', rollNumber: '21R91A7403', imageUrl: '' },
    { id: 'cm2', name: 'A.Balu', rollNumber: '22R91A7401', imageUrl: '' },
    { id: 'cm3', name: 'Maheshwari Arroju', rollNumber: '22R91A7403', imageUrl: '' },
    { id: 'cm4', name: 'Srujana', rollNumber: '22R91A7404', imageUrl: '' },
    { id: 'cm5', name: 'B.Sanjana', rollNumber: '22R91A7405', imageUrl: '' },
    { id: 'cm6', name: 'Banka Karthik Reddy', rollNumber: '22R91A7407', imageUrl: '' },
    { id: 'cm7', name: 'Praveen', rollNumber: '22R91A7408', imageUrl: '' },
    { id: 'cm8', name: 'Bellamkonda Srinivas', rollNumber: '22R91A7409', imageUrl: '' },
    { id: 'cm9', name: 'B. Shiva Kumar', rollNumber: '22R91A7410', imageUrl: '' },
      ...
      { id: 'cm26', name: 'Sirimalla Navyasri', rollNumber: '22R91A7452', imageUrl: '' },
